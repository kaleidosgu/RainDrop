...
[ExecuteInEditMode]
public class ClickRainBehaviour : RainBehaviourBase {

	#region [ Internal Variables ]

	[HideInInspector]
	ClickRainController rainController
	{
		get;
		set;
	}
	...
	[SerializeField]
	public ClickRainVariables Variables;
	...
	ClickRainController CreateController ()
	{
		Transform tr = RainDropTools.CreateHiddenObject ("Controller", this.transform);
		ClickRainController con = tr.gameObject.AddComponent <ClickRainController> ();
    ...
    private void OnDrawGizmos()
    {
        ...
        if (rainController != null)
        {
            ...
            {
                if (dc.currentState == ClickRainController.DrawState.Playing)
